...
contract FHEArithmetic is ZamaEthereumConfig {
    ...
    /// inputA: The encrypted value for operand A
    ...
    /// inputB: The encrypted value for operand B
    /// inputProof: The proof validating the encrypted input
    ...
    /// Computes encrypted addition: result = a + b
    function computeAdd() external {
        _result = FHE.add(_a, _b);
        _grantPermissions();
    }

    /// Computes encrypted subtraction: result = a - b
    ...
    /// Computes encrypted multiplication: result = a * b
    ...
    /// Computes encrypted division: result = a / b (scalar)
    ...
    /// Computes encrypted remainder: result = a % b (scalar)
    ...
    /// Computes encrypted minimum: result = min(a, b)
    function computeMin() external {
        _result = FHE.min(_a, _b);
        _grantPermissions();
    }

    /// Computes encrypted maximum: result = max(a, b)
