...
export const EXAMPLES: Record<string, ExampleConfig> = {
  ...
  "blind-auction": {
    ...
    description:
      "Encrypted blind auction where bids remain confidential. Uses FHE.gt() and FHE.select() to find the winner without revealing losing bids.",
    category: "Advanced",
    title: "Blind Auction",
  },
  "hidden-voting": {
    ...
    description:
      "Encrypted voting mechanism with homomorphic tallying. Individual votes remain private forever while final counts are revealed.",
    category: "Advanced",
    title: "Hidden Voting",
  },
};
