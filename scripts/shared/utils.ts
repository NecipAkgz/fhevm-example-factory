...
/**
 * Generate README content for an example project
 */
export function generateExampleReadme(
  exampleName: string,
  description: string,
  contractName: string
): string {
...
/**
 * Generate README content for a category project
 */
